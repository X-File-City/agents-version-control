/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4beffbcf1fdb171007238b57d2fc8777)
// Runtime types generated with workerd@1.20260421.1 2026-04-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AgentsMcpServer" | "Sandbox" | "RepoDO";
	}
	interface Env {
		...
		ARTIFACTS: Artifacts;
		API_TOKEN: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").AgentsMcpServer>;
		SANDBOX: DurableObjectNamespace<import("./src/index").Sandbox>;
		REPO_OBJECT: DurableObjectNamespace<import("./src/index").RepoDO>;
	}
}
